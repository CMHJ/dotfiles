...
vim.keymap.set("n", "<C-j>", function() require("harpoon"):list():select(1) end, { desc = "Show first entry in harpoon list." })
vim.keymap.set("n", "<C-k>", function() require("harpoon"):list():select(2) end, { desc = "Show second entry in harpoon list." })
vim.keymap.set("n", "<C-l>", function() require("harpoon"):list():select(3) end, { desc = "Show third entry in harpoon list." })
vim.keymap.set("n", "<C-;>", function() require("harpoon"):list():select(4) end, { desc = "Show fourth entry in harpoon list." })
